...
title: Abstracting
date: "2020-11-11"
description: Abstracting, by simplifying, yields the common links, the nexuses, in the fabric of perception and nature. 
keywords: ["abstraction", "abstracting"]
---

![](./jarednielsen-solution-fail-better.png)


@TODO What’s the hook? What is the problem this article is solving? 

## What is Abstracting? 

According to Werner Heisenberg, abstracting is “the possibility of considering an object or group of objects under one viewpoint while disregarding all other properties of the object." 
...
Not only does abstracting improve your problem solving skills, it changes the shape of your brain! Now that's meta! This is especially important if we are working with formal languages, which are, well, not natural. 

How do we change our brains? Practice. According to Barbara Oakley in [A Mind for Numbers](https://amzn.to/2UWpClG): 
...
We make these changes through abstracting, or chunking: 
...
The authors of [Make It Stick](https://amzn.to/2QTzklN) distinguish between two types of intelligence: _fluid_ and _crystallized_, which encapsulate this process of chunking and changing. Fluid intelligence is "the ability to reason, see relationships, think abstractly, and hold information in mind while working on a problem." Crystallized intelligence is "one’s accumulated knowledge of the world and the procedures or mental models one has developed from past learning and experience." According to Brown et al, "...together, these two kinds of intelligence enable us to learn, reason, and solve problems."
...
Looking to form a new abstraction? Check out my latest article, [Data Structures in JavaScript: Tree Node Removal]()
